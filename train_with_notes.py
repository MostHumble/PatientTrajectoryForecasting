                    ...
                    [
                        torch.full(
                            (
                                ...
                                model.bert.config.num_embedding_layers,
                            ),
                            non_pad_token,
                            device=DEVICE,
                        ),
...
def train_transformer(
    ...
    if args.scheduler == "ReduceLROnPlateau":
        ...
        scheduler = lr_scheduler.OneCycleLR(
            optimizer, max_lr=args.learning_rate, total_steps=args.num_train_epochs
        )
    ...
    for epoch in range(args.num_train_epochs):
        ...
        train_loss = train_epoch_with_notes(
            model=transformer,
            optimizer=optimizer,
